...
export default function UserPopover() {
  return (
    <>
        <Popover>
            <PopoverTrigger className="hover:bg-secondary duration-200 border-border border rounded-lg p-2 flex-center gap-2 text-sm"> <PiUserCheckLight size={22}/> Usario Nombre Apellido</PopoverTrigger>
